...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText mTitleEdit, mContentEdit,mCategoryEdit;    // カテゴリ（追加プロパティ）
    private Task mTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryEdit = (EditText)findViewById(R.id.category_edit_text);// カテゴリ（追加プロパティ）
        ...
        if (mTask == null) {
            ...
            mCategoryEdit.setText(mTask.getCategory()); // カテゴリ（追加プロパティ）
    ...
    private void addTask() {
        ...
        String category = mCategoryEdit.getText().toString();   // カテゴリ（追加プロパティ）

        mTask.setTitle(title);
        mTask.setContents(content);
        mTask.setCategory(category);    // カテゴリ（追加プロパティ）
